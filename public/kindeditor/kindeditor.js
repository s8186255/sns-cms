...
KE.lang = {
    ...
    //以下是新增插入附件功能，同时将非法输入的信息和验证也在这里表达清楚。
    accessory : '插入附件',
...
KE.setting = {
    ...
    'italic', 'underline', 'strikethrough', 'removeformat', 'selectall','accessory', 'image',
            ...
            if (range.item) {
                ...
                var getStartEnd = function(isStart) {
                    ...
                    if (!isEnd && startNode.nodeType == 1) {
                        ...
                        return {
                            node: startNode,
                            pos: startNode.nodeType == 1 ? 1 : startNode.nodeValue.length
                            };
                    }
...
KE.plugin['accessory'] = {
    ...
    insert : function(id, url, title, ext) {
        ...
        {
            case "doc":
                img="/kindeditor/others/ico/doc.gif";
                break;
            case "xls":
                img="/kindeditor/others/ico/execl.gif";
                break;
            case "ppt":
                img="/kindeditor/others/ico/ppt.gif";
                break;
            case "rar":
                img="/kindeditor/others/ico/rar.gif";
                break;
            case "zip":
                img="/kindeditor/others/ico/zip.gif";
                break;
            case "txt":
                img="/kindeditor/others/ico/txt.gif";
                break;
            case "pdf":
                img="/kindeditor/others/ico/pdf.gif";
                break;
            default:
                img="/kindeditor/others/ico/attach.gif";
        }
